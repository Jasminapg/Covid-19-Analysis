...
end_day = '2021-04-30'
data_end = '2021-01-25' # Final date for calibration
...
def make_sim(seed, beta, calibration=True, scenario=None, delta_beta=1.6, future_symp_test=None, end_day=None, verbose=0):
    ...
    voc_prop   = 0.62/(1+np.exp(-0.069*(voc_days-sim.day('2020-09-30')))) # Use a logistic growth function to approximate fig 2A of https://cmmid.github.io/topics/covid19/uk-novel-variant.html
...
if __name__ == '__main__':
    ...
    if whattorun=='quickfit':
        s0 = make_sim(seed=1, beta=0.00815, end_day='2021-02-27', verbose=0.1)
        sims = []
