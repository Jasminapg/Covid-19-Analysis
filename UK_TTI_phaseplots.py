...
if scenario == 'phased-june-full-sep':
...
#masks worn at schools, workplaces and parts of community
elif scenario == 'phased-june-full-sep-masks15': 
    h_beta_changes = [1.00, 1.00, 1.29, 1.29, 1.29, 1.00, 1.00, 1.29, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00, 1.00]
    s_beta_changes = [1.00, 0.90, 0.02, 0.02, 0.02, 0.23, 0.38, 0.00, 0.765, 0.00, 0.765, 0.00, 0.765, 0.00, 0.765, 0.00, 0.85]
...
if tti_scen == 'current':
    ...
    # testing in March, May, June and July fitted during calibartion 
    ...
    # under current scenario assumed tracing level to remain the same as in July
    t_eff_june   = 0.68
    t_eff_july   = 0.50
    t_eff_august = 0.50
