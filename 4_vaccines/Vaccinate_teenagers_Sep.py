...
# Filepaths
data_path = 'England_Covid_cases_august30.xlsx'
resfolder = 'results_Vac'

# Important dates
start_day = '2020-01-21'
end_day = '2021-09-10'
data_end = '2021-08-30' # Final date for calibration
...
if __name__ == '__main__':
    ...
    if whattorun=='quickfit':
        s0 = make_sim(seed=1, beta=0.0079, end_day='2021-11-20', verbose=0.1, vx_scenario=0)
        sims = []
