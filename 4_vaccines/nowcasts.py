...
# Filepaths
data_path = 'England_Covid_cases_oct10.xlsx'
...
def make_sim(seed, beta, calibration=True, future_symp_test=None, scenario=None, vx_scenario=None, end_day='2021-10-30', verbose=0):
   ...
   # ADD BETA INTERVENTIONS
    ...
    beta_past  = sc.odict({'2020-02-14': [1.00, 1.00, 0.90, 0.90],
                           ...
                           '2021-07-26': [1.05, 0.00, 0.40, 0.50],
                           '2021-08-02': [1.05, 0.00, 0.40, 0.50],
                           '2021-08-09': [1.05, 0.00, 0.40, 0.50],
                           '2021-08-16': [1.05, 0.00, 0.40, 0.50],
                           '2021-08-23': [1.05, 0.00, 0.40, 0.50],
    ...
    s_prob_dec = 0.07769
    s_prob_jan = 0.07769
    s_prob_march = 0.05069
    s_prob_july21 = 0.05069
...
if __name__ == '__main__':
    ...
    if whattorun=='quickfit':
        ...
        if save_sim:
                    #msim.reduce()
                    msim.reduce(quantiles=[0.25, 0.75])
                    msim.save(f'{resfolder}/uk_sim_calibration_Scenario1test2.obj',keep_people=True)
        if do_plot:
            msim.plot(to_plot=to_plot, do_save=True, do_show=False, fig_path='England_calibration.png',
                      legend_args={'loc': 'upper left'}, axis_args={'hspace': 0.4}, interval=75, n_cols=2)
            msim.plot('variants', do_save=True, do_show=False, fig_path='uk_strain_calibartion.png')
    # Run scenarios
