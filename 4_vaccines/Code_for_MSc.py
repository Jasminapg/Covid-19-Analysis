...
# Filepaths
data_path = 'England_Covid_cases_august10.xlsx'
resfolder = 'results_Vac'

# Important dates
start_day = '2020-01-21'
end_day = '2021-09-10'
data_end = '2021-08-07' # Final date for calibration
...
def make_sim(seed, beta, calibration=True, future_symp_test=None, scenario=None, vx_scenario=None, end_day='2021-10-30', verbose=0):
   ...
   # ADD BETA INTERVENTIONS
    ...
    beta_past  = sc.odict({'2020-02-14': [1.00, 1.00, 0.90, 0.90],
                           ...
                           '2021-05-17': [1.05, sbv, 0.30, 0.40],
                           '2021-05-21': [1.05, sbv, 0.30, 0.40],
                           '2021-05-28': [1.05, 0.00, 0.30, 0.40],
                           '2021-06-07': [1.05, sbv, 0.30, 0.50],
                           '2021-06-14': [1.05, sbv, 0.30, 0.50],
                           '2021-06-19': [1.05, sbv, 0.50, 0.70],
                           '2021-06-21': [1.05, sbv, 0.40, 0.70],
                           '2021-06-28': [1.05, sbv, 0.40, 0.70],
                           '2021-07-05': [1.05, 0.50, 0.30, 0.50],
                           '2021-07-12': [1.05, 0.30, 0.30, 0.30],
                           '2021-07-16': [1.05, 0.00, 0.30, 0.40],
                           '2021-07-26': [1.05, 0.00, 0.30, 0.40],
                           '2021-08-02': [1.05, 0.00, 0.30, 0.40],
                           '2021-08-09': [1.05, 0.00, 0.30, 0.40],
                           '2021-08-16': [1.05, 0.00, 0.30, 0.40],
                           '2021-08-23': [1.05, 0.00, 0.30, 0.40],
                           '2021-09-01': [1.05, 0.63, 0.70, 0.70],
                           '2021-09-15': [1.05, 0.63, 0.70, 0.70],
                           '2021-09-29': [1.05, 0.63, 0.70, 0.70],
                           '2021-10-13': [1.05, 0.63, 0.70, 0.70],
                           '2021-10-22': [1.05, 0.02, 0.50, 0.70],
                           '2021-11-01': [1.05, 0.63, 0.70, 0.70],
                           '2021-11-08': [1.05, 0.63, 0.70, 0.70],
                           '2021-11-15': [1.15, 0.63, 0.50, 0.70],
                           '2021-11-22': [1.15, 0.63, 0.50, 0.70],
                           '2021-12-01': [1.15, 0.63, 0.50, 0.70],
    ...
    tti_day_august21= sim.day('2021-08-30')
    ...
    s_prob_july21 = 0.04769
    #s_prob_august21 = 0.07769
    ...
    interventions += [
        ...
        cv.test_prob(symp_prob=s_prob_july21, asymp_prob=0.008, symp_quar_prob=0.0, start_day=tti_day_july21, test_delay=t_delay),
...
if __name__ == '__main__':
    ...
    if whattorun=='quickfit':
        s0 = make_sim(seed=1, beta=0.0079, end_day='2021-10-10', verbose=0.1, vx_scenario=0)
        sims = []
        ...
        if save_sim:
                    msim.reduce()
                    #msim.reduce(quantiles=[0.25, 0.75])
                    msim.save(f'{resfolder}/uk_sim_calibration.obj',keep_people=True)
        if do_plot:
