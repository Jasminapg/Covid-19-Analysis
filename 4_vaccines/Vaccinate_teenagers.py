...
# Filepaths
data_path = 'England_Covid_cases_august24.xlsx'
resfolder = 'results_Vac'

# Important dates
start_day = '2020-01-21'
end_day = '2021-09-10'
data_end = '2021-08-24' # Final date for calibration
...
def make_sim(seed, beta, calibration=True, future_symp_test=None, scenario=None, vx_scenario=None, end_day='2021-10-30', verbose=0):
   ...
   # ADD BETA INTERVENTIONS
    ...
    beta_past  = sc.odict({'2020-02-14': [1.00, 1.00, 0.90, 0.90],
                           ...
                           '2021-06-19': [1.05, 0.50, 0.40, 0.70],
                           '2021-06-21': [1.05, 0.50, 0.40, 0.70],
                           '2021-06-28': [1.05, 0.50, 0.40, 0.70],
                           '2021-07-05': [1.05, 0.50, 0.40, 0.70],
                           '2021-07-12': [1.05, 0.50, 0.40, 0.70],
    ...
    interventions += [
        ...
        cv.test_prob(symp_prob=s_prob_july21, asymp_prob=0.008, symp_quar_prob=0.0, start_day=tti_day_july21, end_day=tti_day_august21-1, test_delay=t_delay),
...
if __name__ == '__main__':
    ...
    if whattorun=='quickfit':
        s0 = make_sim(seed=1, beta=0.0079, end_day='2021-09-10', verbose=0.1, vx_scenario=0)
        sims = []
