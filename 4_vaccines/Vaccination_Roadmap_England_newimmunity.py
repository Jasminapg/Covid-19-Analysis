...
# Filepaths
data_path = 'England_Covid_cases_may21.xlsx'
resfolder = 'results_delay'

# Important dates
start_day = '2020-01-21'
end_day = '2021-10-30'
data_end = '2021-05-25' # Final date for calibration
   ...
   # ADD BETA INTERVENTIONS
    ...
    if not calibration:
        ...
        if scenario == 'Roadmap_All':
            ...
            beta_scens = sc.odict({'2021-05-28': [1.25, 0.02, 0.50, 0.70],
    ...
    sim['strains'] += [b117]
    # Add B.1.1351 strain
    b1351 = cv.strain('b1351', days=np.arange(sim.day('2020-12-05'), sim.day('2020-12-20')), n_imports=400)
    sim['strains'] += [b1351]
    # Add B.X.XXX strain starting middle of April
    custom_strain = cv.strain(label='custom', strain = cvp.get_strain_pars()['b117'],
                              days=np.arange(sim.day('2021-04-15'), sim.day('2020-04-30')), n_imports=400)
...
if __name__ == '__main__':
    ...
    if whattorun=='quickfit':
        ...
        if do_plot:
            ...
            msim.plot('strain', do_save=True, do_show=False, fig_path=f'uk_strain.png')
    # Run scenarios
