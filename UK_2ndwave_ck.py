...
scenario = ['2ndwave', '1stwave'][0] # Set a number to pick a scenario from the available options
...
#
#sim['rel_severe_prob'] = 1.4
#sim['rel_crit_prob']  = 1.4  # Scale factor for proportion of severe cases that become critical
#sim['rel_death_prob']  = 0.6 # Scale factor for proportion of critical cases that result in death
...
if tti_scen == 'current':
    ...
    print(f'TTI scenario {tti_scen} not recognised')
