...
# Filepaths
data_path = 'England_Covid_cases_Dec312021.xlsx'
resfolder = 'results'
figfolder = 'figs'
...
end_day = '2022-03-10'
data_end  = '2021-12-31' # Final date for calibration -- set this to a date before boosters started
...
def make_sim(seed, beta, end_day='2022-03-10', verbose=0.1):
    ...
    sim = cv.Sim(pars=pars, datafile=data_path, end_day='2022-03-10', location='uk')
   ...
   # ADD BETA INTERVENTIONS
    ...
    omicron.p['rel_beta']         = 6.8
    omicron.p['rel_severe_prob']  = 0.2
    variants += [omicron]
    ...
    # Define booster as a custom vaccination and add it
    booster = dict(
        nab_eff=sc.dcp(sim['nab_eff']),
        nab_init=None,
        nab_boost=3,
...
# Make sim
    ####multi run sims
    s0 = make_sim(seed=1, beta=0.0079, end_day='2022-03-10', verbose=0.1)
    sims = []
