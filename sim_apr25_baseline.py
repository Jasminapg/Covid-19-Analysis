...
end_day   = sc.readdate('2021-04-30')
...
beta_days      = ['2020-02-14', '2020-03-14', '2020-03-23', ti_start]
beta_days      = [(sc.readdate(day)-start_day).days for day in beta_days]
h_beta_changes = [1.00, 1.00, 1.29, 1.00]
s_beta_changes = [1.00, 1.00, 0.00, 1.00]
w_beta_changes = [0.90, 0.90, 0.20, 0.40]
c_beta_changes = [0.90, 0.90, 0.20, 0.40]
...
reduce_kids = False  #set tgis to True to change the transmissibility nubers below
if reduce_kids:
