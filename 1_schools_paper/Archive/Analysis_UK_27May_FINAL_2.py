...
if tti_scen == 'none':
    ...
    s_prob_april = 0.01
    s_prob_may   = 0.0139
    s_prob_june_2 = 0.0139
    a_prob_june_2 = 0.00075
    q_prob_june   = 0.0
    t_delay       = 1.0
    ...
    interventions += [
        cv.test_prob(symp_prob=s_prob_march, asymp_prob=0.0, symp_quar_prob=q_prob, asymp_quar_prob=q_prob, start_day=tc_day, end_day=te_day-1, test_delay=t_delay),
        cv.test_prob(symp_prob=s_prob_april, asymp_prob=0.0, symp_quar_prob=q_prob, asymp_quar_prob=q_prob, start_day=te_day, end_day=tt_day-1, test_delay=t_delay),
        ...
        cv.test_prob(symp_prob=s_prob_june_2, asymp_prob=0.00075, symp_quar_prob=q_prob_june, asymp_quar_prob=q_prob_june, start_day=tti_day, test_delay=t_delay),
