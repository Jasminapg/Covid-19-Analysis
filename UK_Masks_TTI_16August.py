...
scenario = ['phased-june-full-sep-masks15', 'phased-june-full-sep-masks30', 'phased-june-full-sep-masks50', 'phased-june-full-sep-masks15_notschools', 'phased-june-full-sep-masks30_notschools', 'phased-june-full-sep-masks50_notschools'][4] # Set a number to pick a scenario from the available options
tti_scen = ['current', 'optimal_masks15', 'optimal_masks30', 'optimal_masks50', 'optimal_masks15_notschools', 'optimal_masks30_notschools', 'optimal_masks50_notschools'][5] # Ditt0
