...
scenario = ['phased-june-full-sep-masks15', 'phased-june-full-sep-masks30', 'phased-june-full-sep-masks15_notschools', 'phased-june-full-sep-masks30_notschools'][1] #Set a number to pick a scenario from the available options
