...
tti_scen = ['current', '40%', '68%'][2] # Ditto
...
sim['prognoses']['sus_ORs'][1] = 0.5 # ages 10-20
...
if tti_scen == 'current':
    ...
    s_prob_april = 0.012
    s_prob_may   = 0.029
    #testing level from June is the same and 1-(1-0.029)^10)*100%=25%
    s_prob_june = 0.029
    t_delay       = 1.0
...
# Tracing and enhanced testing strategy of symptimatics from 1st June with tracing at 40%
    ...
    #for phased-june-fully_sep testing level =(1-(1-0.143)^10)*100=78%
    #s_prob_june_1 = 0.143 
    #for phased-june-rota_sep testing level =(1-(1-0.115)^10)*100=70%
    s_prob_june_1 = 0.115
    t_delay       = 1.0
    ...
    s_prob_may   = 0.029
    #s_prob_june_2 is increased to minimum value to avoid secondary wave
    #for phased-june-fully_sep testing level =(1-(1-0.09)^10)*100=61%
    #s_prob_june_2 = 0.09
    #for phased-june-rota_sep testing level =(1-(1-0.085)^10)*100=59%
    s_prob_june_2 = 0.085
    t_delay       = 1.0
