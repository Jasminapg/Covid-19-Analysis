...
if __name__ == '__main__':
    ...
    if whattorun=='quickfit':
        s0 = make_sim(seed=1, beta=0.0079, end_day='2021-02-27', verbose=0.1)
        sims = []
    ...
    # Run scenarios
        ...
        for scenname in scenarios:
            ...
            print('---------------\n')
            sc.blank()
            s0 = make_sim(seed=1, beta=0.0079, end_day='2021-04-30', calibration=False, scenario=scenname, verbose=0.1)
