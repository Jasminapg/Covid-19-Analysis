...
scenario = ['phased-june-full-sep-masks15', 'phased-june-full-sep-masks30', 'phased-june-full-sep-masks50', 'phased-june-full-sep-masks15_notschools', 'phased-june-full-sep-masks30_notschools', 'phased-june-full-sep-masks50_notschools'][1] # Set a number to pick a scenario from the available options
tti_scen = ['current', 'optimal_masks15', 'optimal_masks30', 'optimal_masks50', 'optimal_masks15_notschools', 'optimal_masks30_notschools', 'optimal_masks50_notschools'][2] # Ditt0
...
if scenario == 'phased-june-full-sep-masks15':
    ...
    s_beta_changes = [1.00, 0.90, 0.02, 0.02, 0.02, 0.23, 0.38, 0.00, 0.765, 0.00, 0.765, 0.00, 0.765, 0.00, 0.765, 0.00, 0.765, 0.00, 0.765, 0.00, 0.765, 0.00, 0.765, 0.00]
    w_beta_changes = [0.90, 0.80, 0.20, 0.20, 0.20, 0.40, 0.50, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.70]
    c_beta_changes = [0.90, 0.80, 0.20, 0.20, 0.20, 0.40, 0.50, 0.49, 0.765, 0.595, 0.765, 0.595, 0.765, 0.595, 0.765, 0.595, 0.765, 0.595, 0.765, 0.595, 0.765, 0.595, 0.765, 0.90]
...
# masks in schools from 1st September
    ...
    w_beta_changes = [0.90, 0.80, 0.20, 0.20, 0.20, 0.40, 0.50, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.70]
    c_beta_changes = [0.90, 0.80, 0.20, 0.20, 0.20, 0.40, 0.50, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.90]

#Phased opening with society opening and masks effective coverage=50% from 24th July
# masks in schools from 1st September
elif scenario == 'phased-june-full-sep-masks50': 
    h_beta_changes = [1.00, 1.00, 1.29, 1.29, 1.29, 1.00, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29]
    s_beta_changes = [1.00, 0.90, 0.02, 0.02, 0.02, 0.23, 0.38, 0.00, 0.45, 0.00, 0.45, 0.00, 0.45, 0.00, 0.45, 0.00, 0.45, 0.00, 0.45, 0.00, 0.45, 0.00, 0.45, 0.00]
    w_beta_changes = [0.90, 0.80, 0.20, 0.20, 0.20, 0.40, 0.50, 0.25, 0.35, 0.25, 0.35, 0.25, 0.35, 0.25, 0.35, 0.25, 0.35, 0.25, 0.35, 0.25, 0.35, 0.25, 0.35, 0.70]
    c_beta_changes = [0.90, 0.80, 0.20, 0.20, 0.20, 0.40, 0.50, 0.35, 0.45, 0.35, 0.45, 0.35, 0.45, 0.35, 0.45, 0.35, 0.45, 0.35, 0.45, 0.35, 0.45, 0.35, 0.45, 0.90]

if scenario == 'phased-june-full-sep-masks15_notschools':
    h_beta_changes = [1.00, 1.00, 1.29, 1.29, 1.29, 1.00, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.0, 1.29, 1.00, 1.29]
    s_beta_changes = [1.00, 0.90, 0.02, 0.02, 0.02, 0.23, 0.38, 0.00, 0.90, 0.00, 0.90, 0.00, 0.90, 0.00, 0.90, 0.00, 0.765, 0.00, 0.90, 0.00, 0.90, 0.00, 0.90, 0.00]
    w_beta_changes = [0.90, 0.80, 0.20, 0.20, 0.20, 0.40, 0.50, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.425, 0.595, 0.70]
    c_beta_changes = [0.90, 0.80, 0.20, 0.20, 0.20, 0.40, 0.50, 0.49, 0.765, 0.595, 0.765, 0.595, 0.765, 0.595, 0.765, 0.595, 0.765, 0.595, 0.765, 0.595, 0.765, 0.595, 0.765, 0.90]

#Phased opening with society opening and masks effectve coverage=30% from 24th July
# masks only in community and workplacs BUT NOT schools
elif scenario == 'phased-june-full-sep-masks30_notschools':
    h_beta_changes = [1.00, 1.00, 1.29, 1.29, 1.29, 1.00, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29]
    s_beta_changes = [1.00, 0.90, 0.02, 0.02, 0.02, 0.23, 0.38, 0.00, 0.90, 0.00, 0.90, 0.00, 0.90, 0.00, 0.63, 0.00, 0.90, 0.00, 0.90, 0.00, 0.90, 0.00, 0.90, 0.00]
    w_beta_changes = [0.90, 0.80, 0.20, 0.20, 0.20, 0.40, 0.50, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.35, 0.49, 0.70]
    c_beta_changes = [0.90, 0.80, 0.20, 0.20, 0.20, 0.40, 0.50, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.49, 0.63, 0.90]

#Phased opening with society opening and masks effectve coverage=50% from 24th July
# masks only in community and workplacs BUT NOT schools
elif scenario == 'phased-june-full-sep-masks50_notschools':
    h_beta_changes = [1.00, 1.00, 1.29, 1.29, 1.29, 1.00, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29, 1.00, 1.29]
...
# Tracing and enhanced testing strategy of symptimatics from 1st June 
    ...
    s_prob_june = 0.0171
    s_prob_july = 0.0171
    #optimal masks in schools, workplaces and community EC=30; 46%
    s_prob_august = 0.06
    t_delay       = 1.0
    ...
    s_prob_june = 0.0171
    s_prob_july = 0.0171
    #optimal with masks EC=15% but not in schools =72%
    s_prob_august = 0.12
    t_delay       = 1.0
    ...
    s_prob_june = 0.0171
    s_prob_july = 0.0171
    #optimal with masks EC=30% but not in schools =56%
    s_prob_august = 0.08
    t_delay       = 1.0
