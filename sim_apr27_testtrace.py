...
h_beta_changes = [1.00, 1.10, 1.29, 1.09]
s_beta_changes = [1.00, 0.80, 0.00, 1.00]
w_beta_changes = [0.90, 0.70, 0.20, 0.40]
c_beta_changes = [0.90, 0.70, 0.20, 0.40]

#ti_start = '2020-06-01'
#ti_day   = (sc.readdate(ti_start)-start_day).days

#beta_days      = ['2020-02-14', '2020-03-16', '2020-03-23', '2020-04-23', ti_start]
#beta_days      = [(sc.readdate(day)-start_day).days for day in beta_days]
#h_beta_changes = [1.00, 1.10, 1.29, 1.29, 1.00]
#s_beta_changes = [1.00, 0.80, 0.00, 0.00, 0.00]
#w_beta_changes = [0.90, 0.70, 0.20, 0.20, 0.40]
#c_beta_changes = [0.90, 0.70, 0.20, 0.20, 0.40]
