...
end_day   = sc.readdate('2021-02-14')
...
w_beta_changes = [0.90, 0.90, 0.20, 0.30]
c_beta_changes = [0.90, 0.90, 0.20, 0.30]
...
reduce_kids = True  #set tgis to True to change the transmissibility nubers below
if reduce_kids:
