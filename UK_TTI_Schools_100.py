...
scenario = ['jun-opening-full', 'sep-opening-only', 'phased-june-full-sep', 'phased-june-rota-sep'][3] # Set a number to pick a scenario from the available options
tti_scen = ['current', '40%', '68%'][1] # Ditt0
...
if tti_scen == 'current':
    ...
    s_prob_april = 0.012
    s_prob_may   = 0.0198
    #testing level in May and June is (1-(1-0.0198)^10)*100%=18%
    s_prob_june = 0.0198
    t_delay       = 1.0

    iso_vals = [{k:0.1 for k in 'hswc'}]

    #tracing level at 68% from June
    t_eff_june   = 0.68
...
# Tracing and enhanced testing strategy of symptimatics from 1st June with tracing at 40%
    ...
    #for phased-june-fully_sep testing level=(1-(1-0.185)^10)*100=87%
    #s_prob_june_1 = 0.187
    #for phased-june-rota_sep testing level=(1-(1-0.173)^10)*100=75%
    s_prob_june_1 = 0.13
    t_delay       = 1.0

    iso_vals = [{k:0.1 for k in 'hswc'}]

    #tracing level in June is 40%
    t_eff_june   = 0.4
    t_probs_june = {k:t_eff_june for k in 'hwsc'}
    ...
    s_prob_may   = 0.0198
    #s_prob_june_2 is increased to minimum value to avoid secondary wave
    #for phased-june-fully_sep testing level=(1-(1-0.13)^10)*100=75%
    s_prob_june_2 = 0.13
    #for phased-june-rota_sep testing level=(1-(1-0.1)^10)*100=65%
    #s_prob_june_2 = 0.1
    t_delay       = 1.0

    iso_vals = [{k:0.1 for k in 'hswc'}]

    #tracing level from June is 68% for this scenario
    t_eff_june   = 0.68
    t_probs_june = {k:t_eff_june for k in 'hwsc'}
