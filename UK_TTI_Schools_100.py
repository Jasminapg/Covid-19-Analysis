...
tti_scen = ['current', '40%', '68%'][1] # Ditto
...
# Tracing and enhanced testing strategy of symptimatics from 1st June with tracing at 40%
    ...
    #for phased-june-fully_sep testing level=(1-(1-0.17)^10)*100=85%
    s_prob_june_1 = 0.17
    #for phased-june-rota_sep testing level=(1-(1-0.13)^10)*100=75%
    #s_prob_june_1 = 0.13
    t_delay       = 1.0
    ...
    s_prob_may   = 0.0198
    #s_prob_june_2 is increased to minimum value to avoid secondary wave
    #for phased-june-fully_sep testing level=(1-(1-0.1)^10)*100=65%
    s_prob_june_2 = 0.1
